    ...
    <div className="mb-4 flex items-center gap-5 rounded border border-[rgba(255,248,212,0.2)] bg-[rgba(67,86,99,0.2)] p-6 backdrop-blur-[10px]">
      ...
      <div className="flex-1">
        ...
        <div>
          ...
          {timer && (
            <div className="mt-1 text-[10px] font-normal tracking-wide text-[rgba(163,176,135,0.8)]">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="min-w-[40px] text-center text-[15px] font-normal text-[#FFF8D4]">
          {quantity}
        </span>
        <button
          onClick={() => updateQuantity(itemId, quantity + 1)}
