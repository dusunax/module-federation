        ...
        <ul className="m-0 flex list-none items-center gap-1.5 sm:gap-3 p-0">
          ...
          {user ? (
            <li className="relative hidden md:list-item" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div
                  className="absolute -top-4 right-0 w-[calc(100vw-24px)] sm:w-auto min-w-[200px] max-w-[300px] rounded-lg border border-[var(--color-border-primary)] bg-[var(--color-bg-dark)] pb-2 pt-6 shadow-lg"
